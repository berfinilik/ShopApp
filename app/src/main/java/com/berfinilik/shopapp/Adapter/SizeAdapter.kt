...
import com.berfinilik.shopapp.databinding.ViewholderSizeBinding
...
class SizeAdapter(val items: MutableList<String>) :
    ...
    override fun onBindViewHolder(holder: SizeAdapter.Viewholder, position: Int) {
        ...
        holder.binding.sizeTextView.text=items[position]
        ...
        if (selectedPosition == position) {
            ...
            holder.binding.sizeTextView.setTextColor(context.resources.getColor(R.color.purple))
        } else {
            holder.binding.colorLayout.setBackgroundResource(R.drawable.grey_bg)
            holder.binding.sizeTextView.setTextColor(context.resources.getColor(R.color.black))
        }
    }
